...
raw_movies_df = (
  raw_movies_df.select(
     "value",
    lit("jason files ").alias("datasource"),
...
# MAGIC %sql
# MAGIC 
# MAGIC SELECT * FROM movies_bronze WHERE value RLIKE 'the implantation of another'
